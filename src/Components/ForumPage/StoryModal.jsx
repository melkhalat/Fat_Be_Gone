...
class StoryModal extends Component {
  ...
  componentDidMount() {
    ...
    document.getElementById("StoryModalMediaWrapper").style.display = editFile
  ...
  render() {
    ...
    const img = (
      ...
      <Img className="StoryModalMedia" src={src} loader={<Spinner />} />

    );

    const video = (

      <video className="StoryModalMedia" controls src={src}></video>
        ...
        {({ editText, PutFileInLabel, SaveChanges, ToggleModal }) => (
          ...
          <div id="StoryModal">
            ...
            <div id="StoryModalContent" onClick={(e) => e.stopPropagation()}>
              ...
              <div id="StoryModalMediaWrapper">{media}</div>
              ...
              <div id="StoryModalBtnWrapper">
                ...
                >
                  ...
                  <span>Insert Image or Video</span>
